 ...
 * Date: 12-8-14
 */
public class MyInfoActivity extends AbstractAppActivityNoSwipe implements IUserInfo {
    ...
    private class ModifyGroupMemberTask extends MyAsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(MyInfoActivity.this, getString(R.string.modify_successfully), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private class UnFollowTask extends MyAsyncTask<Void, UserBean, UserBean> {
        ...
        protected void onPostExecute(UserBean o) {
            ...
            Toast.makeText(MyInfoActivity.this, getString(R.string.unfollow_successfully), Toast.LENGTH_SHORT).show();
            bean = o;
    ...
    private class FollowTask extends MyAsyncTask<Void, UserBean, UserBean> {
        ...
        protected void onPostExecute(UserBean o) {
            super.onPostExecute(o);
            Toast.makeText(MyInfoActivity.this, getString(R.string.follow_successfully), Toast.LENGTH_SHORT).show();
            bean = o;
    ...
    private class RemoveFanTask extends MyAsyncTask<Void, UserBean, UserBean> {
        ...
        protected void onPostExecute(UserBean o) {
            super.onPostExecute(o);
            Toast.makeText(MyInfoActivity.this, getString(R.string.remove_fan_successfully), Toast.LENGTH_SHORT).show();
            bean = o;
    ...
    class UpdateRemarkTask extends MyAsyncTask<Void, UserBean, UserBean> {
        ...
        protected void onCancelled(UserBean userBean) {
            super.onCancelled(userBean);
            if (this.e != null) {
                Toast.makeText(MyInfoActivity.this, this.e.getError(), Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private LoaderManager.LoaderCallbacks<AsyncTaskLoaderResult<UserBean>> refreshCallback = new LoaderManager.LoaderCallbacks<AsyncTaskLoaderResult<UserBean>>() {
        ...
        public Loader<AsyncTaskLoaderResult<UserBean>> onCreateLoader(int id, Bundle args) {
            return new RefreshLoader(MyInfoActivity.this, bean);
        }
